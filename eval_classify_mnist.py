...
def main():
    ...
    train_loader = torch.utils.data.DataLoader(
        datasets.MNIST('/scratch/ssd001/home/wangkuan/data/', train=True, download=True,
    ...
    test_loader = torch.utils.data.DataLoader(
        datasets.MNIST('/scratch/ssd001/home/wangkuan/data/', train=False, transform=transforms.Compose([
                           transforms.ToTensor(),
                           transforms.Normalize((0.1307,), (0.3081,))
                       ])),
    ...
    ds = check_dataset('mnist', '/scratch/ssd001/home/wangkuan/data', False, True)
